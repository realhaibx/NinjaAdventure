...
public class Player : Character
{
    ...
    private const float MINIMUM_HORIZONTAL_DIFF = 0.1f;
    ...
    public void Attack()
    {
        ...
        ActiveAttack();
        Invoke(nameof(DeactiveAttack), cd / 2);
    }
    ...
    protected override void Dead()
    {
        ...
        Invoke(nameof(OnInit), reviveTime);
    }
    ...
    private new void ChangeAnim(State animName)
    {
